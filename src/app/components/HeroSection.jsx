        ...
        <section className='lg:py-8 lg:mb-[100px]'>
            <div className="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:pt-20 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7 text-center sm:text-left order-1 lg:order-[-1] pt-20">
                    ...
                    <div>
                        <button className='px-6 py-3 w-full font-bold sm:w-fit rounded-full mr-4 bg-gradient-to-br from-purple-100 via-violet-400 to-blue-500 hover:bg-slate-200 text-white shadow-inner'>Hire Me</button>
                        <button className='px-1 py-1 w-full font-bold sm:w-fit rounded-full bg-gradient-to-br from-purple-100 via-violet-400 to-blue-500 hover:bg-slate-800 text-black mt-3 shadow-inner'>
                            <span className='block bg-[#f5f5f5] hover:bg-slate-200 rounded-full px-5 py-2'>Download CV</span>
                        </button>
                    </div>
                </div>
