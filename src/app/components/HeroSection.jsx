        ...
        <section className='lg:py-8 lg:mb-[100px]'>
            <div className="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:pt-20 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7 text-center sm:text-left order-1 lg:order-[-1] pt-20">
                    ...
                    <div>
                        <button className='px-6 py-3 w-full font-bold sm:w-fit rounded-full mr-4 bg-gradient-to-br from-purple-100 via-violet-400 to-blue-500 hover:bg-slate-200 text-white shadow-inner'><a href='https://www.linkedin.com/in/fedor-tatarintsev'>Hire Me</a></button>
